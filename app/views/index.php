...
<head>
    ...
    <!-- SITE TITLE -->
    <title>Schedulous - Making planning easier</title>
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse" id="kane-navigation">
                    <ul class="nav navbar-nav navbar-right main-navigation">
                        ...
                        <li><a href="#brief2">Describe</a></li>
                    ...
                    <div class="intro-section">
                        ...
                        <div class="buttons" id="download-button">
                            ...
                            <a href="#download" class="btn btn-default btn-lg standard-button"><i
                                    class="icon-app-download"></i>Download App</a>
            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="subscription-form-container">
                        ...
                        <h2 class="wow fadeInLeft animated" data-wow-offset="10" data-wow-duration="1.5s">Want to be a
                            private beta tester?
                            <br>Sign Up Now!</h2>
                        ...
                        <form class="subscription-form form-inline wow fadeInRight animated"
                            ...
                            <h4 class="subscription-error"></h4>
                             ...
                             EMAIL INPUT BOX
                            <input type="email" name="email" id="subscriber-email" placeholder="Your Email"
                                   class="form-control input-box">

                             SUBSCRIBE BUTTON
                            <button type="submit" id="subscribe-button" class="btn btn-default standard-button">
                                I'm in!
                            </button>
                        ...
                        <form class="subscription-form form-inline wow fadeInRight animated" data-wow-offset="10"
                              data-wow-duration="1.5s" id="subscribe" role="form">

                            <h4 class="subscription-success"><i class="icon_check"></i> Thank you! We will notify you
                                soon.</h4>
...
<footer>
    ...
    <div class="container">
        ...
        <!-- LOGO -->
        <img src="images/logo-footer.png" alt="LOGO" class="responsive-img">
        ...
        <!-- COPYRIGHT TEXT -->
        <p class="copyright">
            ©2014 Schedulous, All Rights Reserved
        </p>
